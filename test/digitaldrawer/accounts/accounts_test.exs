defmodule Digitaldrawer.AccountsTest do
  ...
  describe "users" do
    ...
    @invalid_attrs %{age: nil, email: nil, password_hash_one: nil, password_hash_two: nil, username: nil}
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      assert user.password_hash_one == "some password_hash_one"
      assert user.password_hash_two == "some password_hash_two"
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert user.password_hash_one == "some updated password_hash_one"
      assert user.password_hash_two == "some updated password_hash_two"
